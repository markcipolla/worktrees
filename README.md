...
| Command                          | Purpose                                                             |
| -------------------------------- | ------------------------------------------------------------------- |
| `worktrees up <path>`         | Allocate everything the config declares. Idempotent. `--force` re-runs. |
| `worktrees down <path>`       | Drop databases, delete the env file, forget the allocation.        |
